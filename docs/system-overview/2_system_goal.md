...
- **Implements Role-Based Access Control (RBAC)**, ensuring that user access is securely managed through permissions tailored to specific roles such as students, HODs, and administrators.
### Problem Addressed
